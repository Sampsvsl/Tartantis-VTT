...
osascript << EOF
display dialog "O Tartantis VTT está rodando!
O jogo foi aberto no seu navegador.

Feche esta janela para desligar o servidor." buttons {"Desligar"} default button "Desligar" with title "Tartantis VTT"
EOF
